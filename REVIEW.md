...
> - [[TECHNICAL_DESIGN]] — архитектура (содержит неточности, см. раздел 1)
> - [[PROJECT_STATE]] — текущее состояние проекта
> - [[TASK_QUEUE]] — очередь задач (приоритетные исправления в разделе 12)
> - [[PLAN_10x]] — план достижения 10/10 (пересекается с рекомендациями)
