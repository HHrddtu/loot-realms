...
export class SaveLoadSystem {
    ...
    collectSaveData() {
        ...
        return {
            ...
            kills: s.kills ?? 0,
            stumpsBroken: s.stumpsBroken ?? 0,
            corruption: s.corruption ?? 0,
            mineUnlocked: s.zones.mine.isUnlocked ?? false,
            mineBossDefeated: s.zones.mine.bossDefeated ?? false,
            hasSecretKey: s.zones.mine.hasSecretKey ?? false,
            caveBossDefeated: s.zones.cave.bossDefeated ?? false,
            bossDefeated: s.zones.arena.bossDefeated ?? false,
            unlockedTalents: s.unlockedTalents ?? [],
            talentPoints: s.talentPoints ?? 0,
            villageFrozen: s.zones.village.isFrozen ?? false,
            villageRestored: s.zones.village.isRestored ?? false,
    ...
    collectAccountData() {
        ...
        return {
            ...acc,
            classKey: s.classKey,
            accountLevel: s.accountLevel ?? 1,
            accountExp: s.accountExp ?? 0,
            accountTalentPoints: s.accountTalentPoints ?? 0,
